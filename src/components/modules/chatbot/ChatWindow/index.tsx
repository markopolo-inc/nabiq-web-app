...
export const ChatWindow: React.FC<ChatWindowProps> = ({ onClick }) => {
  return (
    <div className='absolute bottom-28 right-10 max-w-[400px] w-full bg-primary-600 flex flex-col items-center justify-center hover:cursor-pointer z-[999] rounded-3xl overflow-hidden shadow-2xl'>
