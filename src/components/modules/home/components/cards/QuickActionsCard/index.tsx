...
type QuickActionsProps = { header: string; subHeader: string; medium: string };
...
export const QuickActionsCard: React.FC<QuickActionsProps> = ({
  ...
  return (
    <Stack
      gap={26}
      className='flex-row rounded-[20px] border border-white bg-white/48 backdrop-blur py-4 px-6 shadow-lg'
    >
