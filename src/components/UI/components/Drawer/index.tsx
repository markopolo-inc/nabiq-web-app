import {
  DrawerBodyProps as DrawerBodyFiledProps,
  Drawer as DrawerFiled,
  DrawerProps as DrawerFiledProps,
  DrawerHeaderProps as DrawerHeaderFieldProps,
} from '@mantine/core';
...
export const Drawer = ({ opened, onClose, children, ...rest }: DrawerFiledProps) => {
  return (
    ...
    >
      <DrawerFiled.Overlay />
      <DrawerFiled.Content>{children}</DrawerFiled.Content>
    </DrawerFiled.Root>
  );
};
