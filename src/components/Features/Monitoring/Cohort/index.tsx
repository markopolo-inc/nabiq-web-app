    ...
    return (
        <>
            <Handle
                ...
                id="b"
            />
            <div onClick={() => setIsOperationOpen((prev) => !prev)}
                ...
                <div className="flex justify-between items-center w-full">
                    ...
                    <div
                        className="flex items-center py-0.5 px-2 rounded-2xl border border-gray-200 bg-gray-50 text-gray-700 text-center text-xs font-medium leading-[18px]">
                        Size 20,174
                    </div>
                </div>
