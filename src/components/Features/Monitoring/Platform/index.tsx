...

                {
                    isOperationOpen ? (
                        <>
                            ...
                            <Button variant="primary" trailingIcon={<FiChevronRight />}>View</Button>
                        </>
                    ) : <></>
                }
