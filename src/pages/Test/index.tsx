...
import { ArrowRight, ArrowUp, FiMail01, XClose } from '@nabiq-icons';
import {
  Badge,
  Button,
  Drawer,
  ...
  return (
    <>
      ...
      <div className='space-y-4 space-x-4'>
        ...
        <Button variant='secondary-black' size='md' leadingIcon={<FiMail01 size={16} />}>
          Button
        </Button>
        ...
        <div className='w-72 space-y-6'>
          <TextInput label='Email' leftSection={<FiMail01 size={16} />} placeholder='Enter email' />
          ...
          <DrawerBody>
            <div className='rounded-xl border border-gray-200 p-8 flex flex-col gap-8 w-full'>
              ...
              <div className='font-open text-xs font-medium leading-7 text-gray-600'>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt quod nobis magni
                qui tenetur non eum voluptatibus, maxime quos, ducimus ullam voluptatum nam ipsam
                soluta numquam asperiores pariatur corporis facere necessitatibus? Dolorum vero
                deserunt, provident aperiam possimus modi esse quaerat, facilis qui accusamus animi
                aspernatur, maiores tenetur non hic inventore? Neque aliquid quos, fugiat a dicta
                eos nulla veniam sapiente explicabo necessitatibus officiis odit, molestias
                molestiae non debitis, ipsa iure quisquam. Facere iusto accusantium debitis cum unde
                voluptatibus autem magnam? Voluptatum odit nisi reiciendis quibusdam, ex beatae
