...
import { Badge, Button, Drawer, DrawerBody, DrawerHeader, Group, Select, Text, TextInput, useDisclosure } from "@nabiq-ui";
                ...
                <DrawerHeader>
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-2">
                            <div className="font-open text-lg font-semibold leading-7 text-left">Discover Bali</div>
                ...
                <DrawerBody>
                    <div className="rounded-xl border border-gray-200 p-8 flex flex-col gap-8 w-full">
                        ...
                        <div className="font-open text-xs font-medium leading-7 text-gray-600">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt quod nobis magni qui tenetur non eum voluptatibus, maxime quos, ducimus ullam voluptatum nam ipsam soluta numquam asperiores pariatur corporis facere necessitatibus? Dolorum vero deserunt, provident aperiam possimus modi esse quaerat, facilis qui accusamus animi aspernatur, maiores tenetur non hic inventore? Neque aliquid quos, fugiat a dicta eos nulla veniam sapiente explicabo necessitatibus officiis odit, molestias molestiae non debitis, ipsa iure quisquam. Facere iusto accusantium debitis cum unde voluptatibus autem magnam? Voluptatum odit nisi reiciendis quibusdam, ex beatae ipsam expedita nam veritatis.
                        </div>
