        ...
        <Stack gap={16}>
          ...
          <Stack gap={180} className='flex flex-row'>
            ...
            <Group gap={32}>
              ...
              <Button variant='primary-destructive' size='md' disabled>
                <FiCircle size={20} />
              </Button>
              <Button variant='primary-destructive' size='lg' disabled>
                <FiCircle size={24} />
              </Button>
            </Group>
          </Stack>
          ...
          <Stack gap={180} className='flex flex-row'>
            ...
            <Group gap={32}>
              ...
              <Button variant='primary-destructive' size='md' loading>
                <FiCircle size={20} />
              </Button>
              <Button variant='primary-destructive' size='lg' loading>
                <FiCircle size={24} />
              </Button>
            </Group>
          </Stack>
