...
import { FiHourglass03, FiDataFlow02, Calendar } from "@nabiq-icons";
...
const Monitoring = () => {
  const [category, setCategory] = useState<"overview" | "breakdown">(
    "overview"
  );
          ...
          <Group justify="space-between">
            ...
            <Group>
              <Select
                ...
                value={timeRange}
                onChange={(value) =>
                  setTimeRange(value as "today" | "last_week" | "last_month")
                }
                data={[
